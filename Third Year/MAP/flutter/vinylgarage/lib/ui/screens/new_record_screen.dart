...
class _NewRecordScreenState extends State<NewRecordScreen> {
  ...
  void _addRecord(BuildContext context, RecordProvider provider) {
    try {
      if (!_checkFields(provider)) {
        provider.insertNewRecord();
      ...
      _showValidationSnackBar(context, 'Error adding record', Colors.red);
    }
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title:
              const Text('Add record', style: TextStyle(color: Colors.black)),
          ...
          builder: (context, provider, child) => SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    _addRecord(context, provider);
                  },
                  child: const Center(child: Text('Add record')),
                )
              ],
            ),
          ),
