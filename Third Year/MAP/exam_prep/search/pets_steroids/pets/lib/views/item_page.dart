...
class ItemPage extends StatelessWidget {
  final int _attribute;

  const ItemPage(this._attribute, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Item>>(
        future: dataService.getItemsByAttribute(_attribute),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(
                        'Breed: ${item.breed}, Age: ${item.age}, Weight: ${item.weight}, Owner: ${item.owner}, Location: ${item.location}, Description: ${item.description}'
                    ),
                    trailing: IconButton(
