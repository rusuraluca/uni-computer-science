...
const String wsUrl = 'ws://10.0.2.2:2320'; //TODO: CHANGE HERE
          ...
          children: [
            ...
            ElevatedButton(
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => const RecordSection()));
                },
            ...
            ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => const ProfileSection()));
                },
            ...
            ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => ReportsSection()));
                },
