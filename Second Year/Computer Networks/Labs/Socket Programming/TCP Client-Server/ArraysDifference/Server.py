    ...
    while True:
        ...
        if received_n == '0' and received_m == '0':
            ...
            def not_common(l1, l2):
                ...
                for l in l1:
                    if l not in l2:
                        not_commons.append(l)
                return not_commons

            not_commons = not_common(list_1, list_2)

            # send the data to the client
            tcp_send_int(client_socket, len(not_commons))
            for ncom in not_commons:
                tcp_send_int(client_socket, ncom)
