...
import Model.Collections.MyIProcedureTable;
...
public class ProgramExecutorController {
    ...
    private void populateExecutionStackListView() {
        ...
        if (programState != null)
            for (Statement statement: programState.getExeStack().getReversed()) {
    ...
    private void populateProcedureTableView() {
        ...
        for(Map.Entry<String, javafx.util.Pair<List<String>, Statement>> entry: procedureTable.getContent().entrySet()) {
