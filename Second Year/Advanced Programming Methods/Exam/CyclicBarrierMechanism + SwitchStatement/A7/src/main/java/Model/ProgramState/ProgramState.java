...
public class ProgramState {
    ...
    public ProgramState(IStack<Statement> stack, IDictionary<String,Value> symTable, IList<Value> out,
                        ...
                        ILockTable lockTable, IBarrierTable barrierTable, Statement program) {
        this.exeStack = stack;
    ...
    public ProgramState(IStack<Statement> stack, IDictionary<String,Value> symTable, IList<Value> out,
                        IDictionary<String, BufferedReader> fileTable, IHeap heap, ILockTable lockTable, IBarrierTable barrierTable) {
        this.exeStack = stack;
        this.symTable = symTable;
        this.out = out;
        this.fileTable = fileTable;
