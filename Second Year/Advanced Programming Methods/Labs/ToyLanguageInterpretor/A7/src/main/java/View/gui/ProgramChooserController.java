...
public class ProgramChooserController {
    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                selectedStatement.typeCheck(new Dictionary<>());
                ProgramState programState = new ProgramState(new Stack<>(), new Dictionary<>(), new List<>(), new Dictionary<>(), new Heap(), new LockTable(), selectedStatement);
