/*
Write a c program using threads that receives as command line arguments the name of a file and the number of threads to create 
in order to calculate the number of letters and digits in the file.
*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
